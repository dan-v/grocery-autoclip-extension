// ABOUTME: Background script that handles coupon clipping automation, storage, and state management
// ABOUTME: Processes clipping requests, manages sessions, updates badges, and coordinates with content scripts
