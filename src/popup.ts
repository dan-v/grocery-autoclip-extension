// ABOUTME: Popup UI script that manages the extension interface and user interactions
// ABOUTME: Handles dashboard, coupon display, clipping control, and background monitoring
